...
# Agregar un script en JavaScript para preseleccionar un valor en el filtro
js_preselect <- tags$script(HTML("
  $(document).ready(function() {
    setTimeout(function() {
      document.getElementById('sujeto_obligado_filter').getElementsByClassName('selectized')[0].selectize.setValue('Administración de Parques Nacionales', false);
    }, 500);
  });
"))
