...
vbs <- list(
  value_box(
    title = "Organismos",
    value = length(unique(df_transparencia$sujeto_obligado)),
    showcase = bs_icon("building"),
    theme = value_box_theme(bg = "#6b579e", fg = "white")
    ),
  value_box(
    title = "Ítems de Transparencia Activa",
    value = "13",
    showcase = bs_icon("card-checklist"),
    theme = value_box_theme(bg = "#6b579e", fg = "white")
    ),
  value_box(
    title = "ítems de Transparencia Proactiva",
    value = "7",
    showcase = bs_icon("card-checklist"),
    theme = value_box_theme(bg = "#6b579e", fg = "white")
  )
